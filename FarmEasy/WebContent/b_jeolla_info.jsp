...
<link rel="stylesheet" href="css/jeolla_info.css">
<link
...
<body>
	...
	<div id="sub-title" class="wd-basic-960 mb-auto">전라도 정책 조회</div>

	<div id="sta-location" class="wd-basic-960">
		<ul>
			<li><span><a href="b_all_info.jsp">전체보기</a></span> <span><a
					href="b_chungcheong_info.jsp">충청도</a></span> <span><a
					href="b_gyeongsang_info.jsp">경상도</a></span> <span>전라도</span></li>
			<li><a href="index.jsp">홈&nbsp;</a>&nbsp;>&nbsp;전라도 정책
				조회&nbsp;&nbsp;</li>
		</ul>
	</div>
