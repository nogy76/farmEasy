  ...
  <!-- nav 시작 -->
    ...
    <nav class="navbar">
      ...
      <ul class="navbar-icon">
        <li><a href="index.jsp" onclick="popLogout()">로그아웃</a></li>
        <li><a href="f_myPage.jsp">마이페이지</a></li>
      </ul>
      <a href="#" class="navbar-more">
        <i class='fa fa-bars' style='color: white; margin-top: 14px;'></i>
      </a>
    </nav>
...
<div class="mb-5" style="height: 500px; margin-top: 20vh;">
        ...
        <div class="signup_div">
          <table>
            <tr>
              ...
              <td>
                <input class="login-input-wrap b" type="password" name="user_pw"></input>
              </td>
            </tr>
          </table>
        </div>
        <div class="login-button-wrap">
          <a href="f_myPage_Edit.jsp">
            <input type="button" value="정보 수정" onclick="success_signup()"></input>
          </a>
        </div>
      </fieldset>
      </div>
  ...
  <footer>
      <div class="container">
          ...
          <ul>
            <li class="ms-3"><a class="text-muted" href="#"><svg class="bi" width="24" height="24"><img src="images/iconmonstr-twitter-4.svg"></svg></a></li>
            <li class="ms-3"><a class="text-muted" href="#"><svg class="bi" width="24" height="24"><img src="images/iconmonstr-facebook-4.svg"></svg></a></li>
            <li class="ms-3"><a class="text-muted" href="#"><svg class="bi" width="24" height="24"><img src="images/iconmonstr-instagram-14.svg"></svg></a></li>
          </ul>
      </div>
    </footer>
</body>
