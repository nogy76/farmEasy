...
<%
	...
	BoardDto boardDto = farmEasyDao.getBoardDB((int)(session.getAttribute("updateDeleteBoardId")));
%>
...
<body>
	...
	<div class="wd-basic-960 mb-auto mt-4" id="info-bottom"
		style="height: 650px;">
		<form name="FEForm1" method="post" action="update.do">
			<table>
				<tr>
					<th>제목</th>
					<td>
						<div>
							<span>
								<input type="text" title="제목" maxlength="1900" name="board_title" value="<%=boardDto.getBoard_title() %>" required>
							</span>
						</div>
					</td>
				</tr>
				...
				<tr>
					<th>내용</th>
					<td>
						<textarea name="board_content" id="nttCn" class="textarea100" title="내용" wrap="hard"><%=boardDto.getBoard_content() %></textarea>
					</td>
				</tr>
				<tr>
					<th>첨부파일</th>
